...
export const itemCatalog: ItemDef[] = [
  ...
  // 生活支援・福祉用具
  { key: 'fall_injury', label: '転倒やけが', categoryKey: 'other', options: [
...
export const facilityTypePresets: FacilityTypePreset[] = [
  { key: 'day_service', label: '通所介護・通所リハビリ(デイサービス/デイケア)', itemKeys: [
    'exercise_type_1', 'exercise_type_2', 'exercise_type_3', 'exercise_time',
    'exercise_condition', 'gait', 'adl_other', 'communication',
    'cognitive_function', 'motivation_activity', 'vitals', 'pain', 'fall_injury',
  ] },
  ...
  { key: 'home_nursing', label: '訪問看護・訪問リハビリ', itemKeys: [
    ...
    'hydration', 'oral_condition', 'vitals', 'medication_management',
  ...
  { key: 'facility', label: '施設系(特養・老健・介護医療院・短期入所)', itemKeys: [
    ...
    'meal_form', 'meal_independence', 'meal_intake_amount',
    'oral_condition', 'communication', 'cognitive_function', 'bpsd',
  ...
  { key: 'residential', label: '特定施設・小規模多機能型(入居・複合型)', itemKeys: [
    'transfer_movement', 'toileting', 'bathing', 'adl_other',
    'meal_form', 'meal_independence', 'meal_intake_amount',
    'oral_condition', 'communication', 'cognitive_function',
