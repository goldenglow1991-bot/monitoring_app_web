...
const usageGuideSections: { heading: string; body: string }[] = [
  ...
  {
    heading: '④ 今月の所見を入力',
    body: 'プルダウンでの選択・自由記入欄への入力のどちらでも構いません。両方空欄のままでも生成できるので、無理にすべて埋める必要はありません。項目の左端の「☰」をドラッグすると並び順を入れ替えられ、生成される文章の順番もある程度調整できます。\nまた、「過去の記録の追加・編集」から過去3か月分のモニタリングを入力しておくと、AIによる生成の精度が上がります。',
  },
  { heading: '⑤ 文章を生成', body: '「文章を生成」ボタンでAIが下書きを作成します。生成後の文章は自由に編集できます。' },
  { heading: '⑥ コピーして貼り付け', body: '「文章をコピー」でクリップボードにコピーし、お使いの記録システムなどへ貼り付けてください。' },
  { heading: 'その他', body: '右上の「今月分を出力」から、対象年月の全利用者分の生成結果をまとめてテキストファイルとして書き出すこともできます。' },
  {
    heading: 'ご注意',
