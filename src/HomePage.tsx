...
import { planTiers, totalFreeGenerations, freeGenerationLimit } from './stripePrices';
              ...
              {config.unlimited_access ? (
                ...
                <>
                  ...
                  <span className="usage-status-line">
                    残り{Math.max(0, Math.min(freeGenerationLimit, totalFreeGenerations - ((config.free_generations_used as number | undefined) ?? 0)))}回
                  </span>
                </>
              )}
            </span>
